        ...
        "processor": {
           ...
           #     "normal": "{subject}\n[more]({url})",  # 普通模板
            ...
            "filter": {
                ...
                "mode": "allow",    # allow模式：包含关键词才发送 / block模式：包含关键词不发送
                "scope": "title",   # 检查范围：title/all (只检查标题或标题+摘要)
                "keywords": ["免", "cf", "cl", "黑", "低", "小", "卡", "年", "bug", "白", "github", "节", "闪", "cc", "rn", "动", "cloudcone", "脚本", "代码", "docker", "剩", "gcp", "aws", "oracle", "google", "香港", "奖", "新加坡", "cmi", "hk", "sg", "DMIT", "大妈","t1", "折"]
            },
            "highlight": {
